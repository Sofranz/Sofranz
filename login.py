...
def graphing():
    ...
    button= Button(root, text="input X values", padx=960 , pady=200,command=inputx , bg='grey')
    button.place(bordermode=OUTSIDE, height=100, width=300,x=860,y=300)
    ...
    button= Button(root, text="input y values", padx=960 , pady=200,command=inputx , bg='grey')
    button.place(bordermode=OUTSIDE, height=100, width=300,x=860,y=500 , )
